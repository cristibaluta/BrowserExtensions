...
function copyPaste(m) {
	if (m.message == "copyReviewers") {
		copyReviewers();
	} else if (m.message == "pasteReviewers") {
		pasteReviewers();
	}
}

function copyReviewers() {
	// safari.extension.settings.reviewers = "sddddd";
	alert(safari.extension.secureSettings);
	
	safari.extension.settings.reviewers = document.getElementById("s2id_reviewers").innerHTML;
	alert(safari.extension.settings.reviewers);
}

function pasteReviewers() {
	...
	if (document.getElementById("s2id_reviewers") != null) {
		document.getElementById("s2id_reviewers").innerHTML = safari.extension.settings.reviewers;
	}
}
